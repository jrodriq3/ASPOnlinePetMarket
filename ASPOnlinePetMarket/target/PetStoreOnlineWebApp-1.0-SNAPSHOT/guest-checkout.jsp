<%-- 
    Document   : guest-checkout
    Created on : Sep 10, 2024, 7:32:18 PM
    Author     : Grace
--%>
...
<body>
    ...
    <div class="checkout-container">
        <br> <br>
        <h1 class="checkout-title">Guest Checkout</h1>
        ...
        <div class="checkout-section">
            ...
            <table>
                ...
                <a href="sign-in.jsp">Already a Customer?</a>
        <form action="GuestCheckoutServlet" method="POST">
